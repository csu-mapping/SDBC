## Geographical flow clustering

This project incudes the code and data used in the paper:
...
The source code are implemented with Octave/MATLAB and Python (version 3.8).

#### Simulated data

The simulated dataset were stored in the folder 'data'
